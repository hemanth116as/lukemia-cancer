...
@app.route('/')
def index():
    return render_template('index.html', predicted_label=None, error=None)
...
def predicting():
    try:
        ...
        return render_template('index.html', predicted_label=predicted_label, error=None)
    except Exception as e:
        return render_template('index.html', predicted_label=None, error=str(e))
